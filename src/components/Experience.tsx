...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-20 bg-slate-800" ref={ref}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 text-center">
            Work <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Experience</span>
          </h2>
          ...
          <div className="max-w-4xl mx-auto">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="md:ml-8 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8 hover:bg-white/10 transition-all duration-300">
                  <div className="absolute -left-3 top-8 w-6 h-6 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full border-4 border-slate-800 hidden md:block" />
